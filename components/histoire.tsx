        ...
        >
          <div className="grid items-center gap-16 lg:grid-cols-[1.1fr_1fr]">
            ...
            <div className="relative mx-auto aspect-square w-full max-w-[580px]">
              ...
              {/* App B2C — haut droite */}
              <figure className="absolute top-[2%] right-[2%] z-[3] m-0 w-[20%]" style={{ transform: "rotate(5deg)", filter: "drop-shadow(0 14px 26px rgba(40,25,10,0.20))" }}>
                <div className="overflow-hidden rounded-xl border border-border bg-white" style={{ aspectRatio: "9/19" }}>
                  <Image src="/work-b2c-app.png" alt="App B2C" fill className="object-cover" sizes="120px" />
                </div>
              ...
              {/* App B2B — gauche */}
              <figure className="absolute top-[10%] left-0 z-[3] m-0 w-[32%]" style={{ transform: "rotate(-4deg)", filter: "drop-shadow(0 14px 26px rgba(40,25,10,0.20))" }}>
                <div className="overflow-hidden rounded-[10px] border border-border bg-white" style={{ aspectRatio: "16/9" }}>
                  <Image src="/work-b2b-app.png" alt="App B2B" fill className="object-cover" sizes="200px" />
                </div>
              ...
              <figure className="absolute right-[4%] bottom-[2%] z-[3] m-0 w-[44%]" style={{ transform: "rotate(3deg)", filter: "drop-shadow(0 16px 28px rgba(40,25,10,0.22))" }}>
                <div className="overflow-hidden rounded-[10px] border border-border bg-white" style={{ aspectRatio: "16/10" }}>
                  <Image src="/work-b2b-saas.png" alt="Logiciel B2B" fill className="object-cover" sizes="280px" />
                </div>
